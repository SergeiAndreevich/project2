...
// итак, это домашняя работа 3, уже после 1 слияния с веткой main.
// думаю, что дальнейшие модификации кода для деплоя буду делать на main, а новую дз в project4